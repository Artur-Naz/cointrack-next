...
const injectedRtkApi = cointrackApi.injectEndpoints({
  endpoints: build => ({
    ...
    PasswordResetRequest: build.mutation<PasswordResetRequestApiResponse, PasswordResetRequestApiArg>({
      query: queryArg => ({
    ...
    EmailVerifyRequest: build.mutation<EmailVerifyRequestApiResponse, EmailVerifyRequestApiArg>({
      query: queryArg => ({
    ...
    EmailVerify: build.mutation<EmailVerifyApiResponse, EmailVerifyApiArg>({
      query: queryArg => ({
    ...
    GoogleAuth: build.mutation<GoogleAuthApiResponse, GoogleAuthApiArg>({
      query: queryArg => ({
    ...
    FacebookAuth: build.mutation<FacebookAuthApiResponse, FacebookAuthApiArg>({
      query: queryArg => ({
    ...
    CoinbaseAuth: build.mutation<CoinbaseAuthApiResponse, CoinbaseAuthApiArg>({
      query: queryArg => ({
    ...
    TelegramAuth: build.mutation<TelegramAuthApiResponse, TelegramAuthApiArg>({
      query: queryArg => ({
...
export type GetUserProfileApiResponse = /** status 200 get user profile */ User
export type GetUserProfileApiArg = void
export type LoginApiResponse =

  /** status 200 You are successfully logged in */
  User | /** status 201  */ undefined
